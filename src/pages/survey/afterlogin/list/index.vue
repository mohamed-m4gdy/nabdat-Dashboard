...
const {
  ...
  totalItems,
  totalPages,
} = tableHock('survey-questions?filters[survey_type]=after_login')
...
<template>
  <div>
    ...
    <PageHeader
      :title="$t('After login')"
      :text="$t('From here you can manage system after login')"
    />
    <AfterLogin />
    <VCard>
      <!-- items table -->
      <IndexTable
        ...
        :headers="headers"
        add-path="survey-afterlogin-add"
        :loading="loading"
        :delete-id="deleteId"
        :items="items"
        :options="options"
          ...
          <td>
            ...
            >
              ...
              <VMenu activator="parent">
                <VList>
                  <VListItem :to="`/survey/afterlogin/list/questionanswers/${item.id}`">
                    <template #prepend>
                      <VIcon icon="mdi-eye-outline" />
                    </template>
                    <VListItemTitle>{{ $t('Answers') }}</VListItemTitle>
                  </VListItem>
                  <VListItem :to="`/survey/afterlogin/edit/${item.id}`">
                    <template #prepend>
