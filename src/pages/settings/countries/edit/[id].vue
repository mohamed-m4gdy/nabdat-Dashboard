...
const { item, loading, getInputError, saveItem, serverErrors } = formHock<Ifrom>('country', 'edit', formSetup, validation, parseInt(route.params.id as string))
