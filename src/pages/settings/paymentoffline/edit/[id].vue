...
const { item, loading, getInputError, saveItem, serverErrors } = formHock<Iform>('payGateOffline', 'edit', formSetup, validation, parseInt(route.params.id as string))
        ...
        <VRow>
          <VCol md="9">
            <VRow>
              ...
              >
                <Search
                  v-model="item.paymentGate.title"
