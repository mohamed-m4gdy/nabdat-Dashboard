...
const {
  ...
  addFilter,
  resetFilter,
} = tableHock('home-visits/assistants')
...
const headers = [
  ...
  { title: 'SERVICE', key: 'service.title' },
...
<template>
  <div>
    ...
    <PageHeader
      :title="$t('Home visits assistants')"
      :text="$t('From here you can manage system home visits assistants')"
    />
    <Filter
      :fillters="fillters"
          ...
          <td>
            ...
            >
              ...
              <VMenu activator="parent">
                <VList>
                  <VListItem :to="`/homevisits/assistants/log/${item.id}`">
                    <template #prepend>
