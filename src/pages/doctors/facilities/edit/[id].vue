...
const { item, loading, getInputError, saveItem, serverErrors } = formHock<Ifrom>('facilities', 'edit', formSetup, validation, parseInt(route.params.id as string))
