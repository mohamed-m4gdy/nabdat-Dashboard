...
const {
  ...
  totalItems,
  totalPages,
} = tableHock(`survey/${route.params.id}/answers`)
...
const headers = [
  { title: 'ID', key: 'id' },
  { title: 'USER', key: 'user' },
  { title: 'QUESTION', key: 'question.question' },
...
<template>
  <div>
    <Breadcrubs
        :links="[
          ...
          },
          {
            ...
            link: `/doctors/specialities/${route.params.specialityId}/survey/list`
          },
          {
            title: $t('Answers')
          }
    ...
    />
    <Speciality
        v-if="route.params.specialityId"
        :items="items"
      />
    <VCard>
      <!-- items table -->
