...
const rules = {
  question: {
    ar: {
      ...
      maxLength: helpers.withMessage('Question in arabic must be smaller than or equal 666', maxLength(666)),
    },
    en: {
      ...
      maxLength: helpers.withMessage('Question in english must be smaller than or equal 666', maxLength(666)),
    },
  },
  type: {
