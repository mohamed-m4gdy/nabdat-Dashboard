      ...
      <VCardText v-if="item.module == 'booking'">
        ...
        <VRow class="mt-3">
          ...
          <VCol sm="6">
            <h6 class="text-sm mt-1 font-weight-medium">
              {{ $t('Status') }}:
              <span class="text-capitalize text-body-2">{{item.module_data[0]?.speciality?.status }}</span>
            </h6>
          </VCol>
          <VCol sm="6">
            <h6 class="text-sm mt-1 font-weight-medium">
              {{ $t('Created date') }}:
              <span class="text-capitalize text-body-2">{{item.module_data[0]?.speciality?.created_at }}</span>
            </h6>
          </VCol>
        </VRow>
      </VCardText>
