...
const {
  ...
  addFilter,
  resetFilter,
} = tableHock<booking>('bookings?filters[calendar_type]=call')
  ...
  <div>
    <Breadcrubs
      :links="[
        ...
        {
          title: $t('Bookings calls')
        }
      ]"
    />
    <PageHeader
      :title="$t('Bookings calls')"
      :text="$t('From here you can manage Bookings calls')"
    />
    <Filter
      :fillters="fillters"
          ...
          <td>
            ...
            >
              ...
              <VMenu activator="parent">
                <VList>
                  <VListItem :to="`/booking/calls/show/${item.id}`" >
                    <template #prepend>
                      <VIcon icon="mdi-eye" />
                    </template>
