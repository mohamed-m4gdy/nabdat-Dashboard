...
const {
  ...
  addFilter,
  resetFilter,
} = tableHock(`approvals/complete?filters[model_type]=App\\Models\\User`, false, true, true)
          ...
          <td>
            ...
            >
              ...
              <VMenu activator="parent">
                <VList>
                  <VListItem :to="`/approvals/approvalsdoctorapp/${item.id}/data/list`">
                    <template #prepend>
