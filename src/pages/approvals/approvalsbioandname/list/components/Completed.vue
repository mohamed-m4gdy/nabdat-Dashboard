...
const {
  ...
  addFilter,
  resetFilter,
} = tableHock(`approvals/complete?filters[model_type]=App\\Models\\Doctor&filters[action]=edit_doctor_info`, false, true, true)
          ...
          <td>
            ...
            >
              ...
              <VMenu activator="parent">
                <VList>
                  <VListItem :to="`/approvals/approvalsbioandname/${item.id}/data/list`">
                    <template #prepend>
