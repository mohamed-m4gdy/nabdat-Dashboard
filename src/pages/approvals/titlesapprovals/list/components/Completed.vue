...
const {
  ...
  addFilter,
  resetFilter,
} = tableHock(`approvals/complete?filters[model_type]=App\\Models\\Doctor&filters[action]=edit_doctor_title`, false, true, true)
          ...
          <td>
            ...
            >
              ...
              <VMenu activator="parent">
                <VList>
                  <VListItem :to="`/approvals/titlesapprovals/${item.id}/data/list`">
                    <template #prepend>
