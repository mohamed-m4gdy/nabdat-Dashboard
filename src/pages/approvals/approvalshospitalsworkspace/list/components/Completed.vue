...
const {
  ...
  addFilter,
  resetFilter,
} = tableHock(`approvals/complete?filters[action][]=create_hospital_workspace&filters[action][]=update_hospital_workspace&filters[model_type]=App\\Models\\Workspace`, false, true, true)
