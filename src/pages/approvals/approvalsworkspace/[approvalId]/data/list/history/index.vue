          ...
          <div class="w-100">
            ...
            <div class="py-3 px-4">
              ...
              <div class="mb-2 d-flex gap-1" :class="items.object?.organization?.name !== item.organization?.name ? 'highlight' : ''">
                <h4>{{ $t('Doctor name in identity') }}:</h4>
              ...
              <div class="mb-2 d-flex gap-1" :class="items.object?.doctor?.name !== item.doctor?.name ? 'highlight' : ''">
                <h4>{{ $t('Doctor') }}:</h4>
              ...
              <div class="mb-2 d-flex gap-1" :class="items.object?.waiting_time !== item.waiting_time ? 'highlight' : ''">
                <h4>{{ $t('Waiting time') }}:</h4>
                <div>{{ item.waiting_time }}</div>
              </div>
              <div class="mb-2 d-flex gap-1" :class="items.object?.cost !== item.cost ? 'highlight' : ''">
                <h4>{{ $t('Cost') }}:</h4>
                <div>{{ item.cost }}</div>
              </div>
              <div class="mb-2 d-flex gap-1" :class="items.object?.follow_up_cost !== item.follow_up_cost ? 'highlight' : ''">
                <h4>{{ $t('Follow up cost') }}:</h4>
                <div>{{ item.follow_up_cost }}</div>
              </div>
              ...
              <div class="mb-2 d-flex gap-1" :class="items.object?.allow_online_pay !== item.allow_online_pay ? 'highlight' : ''">
                <h4>{{ $t('Allow pay online') }}:</h4>
                <div>
                  <VChip
                      v-if="items.object.allow_online_pay"
                      color="success"
                      class="font-weight-medium"
                      size="small"
                    >
              ...
              <div class="mb-2 d-flex gap-1" :class="items.object?.lat_lon !== item.lat_lon ? 'highlight' : ''">
                <h4 class="no-wrap">{{ $t('Lat and lon') }}:</h4>
