...
const {
  ...
  addFilter,
  resetFilter,
} = tableHock(`approvals/complete?filters[action][]=doctor_create_workspace&filters[action][]=update_workspace&filters[model_type]=App\\Models\\Workspace`, false, true, true)

// table headers
const headers = [
  { title: 'ID', key: 'id' },
  { title: 'CLINIC', key: 'name' },
  { title: 'DOCTOR', key: 'model_data.doctor.name' },
    ...
    <VCard>
      ...
      >
        ...
        >
          ...
          <td>
            {{ item.model_data?.doctor?.name }}
          </td>
          <td>
            <span v-if="item.action === 'doctor_create_workspace'">
              {{ $t('New') }}
            </span>
            <span v-if="item.action === 'update_workspace'">
              {{ $t('Update') }}
            </span>
          </td>
          <td>
          ...
          <td>
            ...
            >
              ...
              <VMenu activator="parent">
                <VList>
                  <VListItem :to="`/approvals/approvalsworkspace/${item.id}/data/list`">
                    <template #prepend>
