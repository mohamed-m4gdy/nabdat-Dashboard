...
const {
  ...
  addFilter,
  resetFilter,
} = tableHock(`approvals/complete?filters[model_type]=App\\Models\\Doctor&filters[action]=edit_doctor_photo`, false, true, true)
      ...
      >
        ...
        >
          ...
          <td>
            ...
            <span v-if="item.action === 'edit_doctor_photo'">
              {{ $t('Update') }}
            </span>
          </td>
          <td>
          ...
          <td>
            ...
            >
              ...
              <VMenu activator="parent">
                <VList>
                  <VListItem :to="`/approvals/approvalsdoctorphoto/${item.id}/data/list`">
                    <template #prepend>
