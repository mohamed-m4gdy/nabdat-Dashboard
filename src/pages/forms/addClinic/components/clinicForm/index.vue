...
const formSetup: Iform = {
  ...
  doctor_id: params.value.doctor_id ? params.value.doctor_id : null,
  country_id: null,
  government_id: null,
  city_id: null,
  calling_code: null,
  ...
  lat: null,
  lon: null,
  speciality_id: params.value.spicialty_id ? params.value.spicialty_id : null,
  ...
  <VRow>
    ...
    >
      <Search
        ...
        :disabled="!item.speciality_id || params.doctor_id"
          :fillter="{
