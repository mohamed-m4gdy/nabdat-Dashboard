...
const { item, loading, getInputError, saveItem, serverErrors } = formHock<Iform>('WorkspaceCategory', 'edit', formSetup, validation, parseInt(route.params.id as string))
...
<template>
  <div>
    <div>
      ...
      :links="[
        ...
        },
        {
          ...
          link: '/hospitals/workspacecategory/list'
        },
        {
          title: $t('Edit'),
        }
    ...
    <VCard
      id="invoice-list"
      :title="$t('Edit Workspace Category')"
    >
      <Form
        :loading="loading"
        :errors="[]"
