...
const { item, loading, getInputError, saveItem, serverErrors } = formHock<Iform>('patient/support-category', 'add', formSetup, validation)
...
<template>
  <div>
    ...
    <VCard
      id="invoice-list"
      :title="$t('Add patient support category')"
    >
      <Form
        :loading="loading"
        :errors="[]"
