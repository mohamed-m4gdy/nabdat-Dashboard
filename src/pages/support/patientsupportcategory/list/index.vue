...
const {
  ...
  totalItems,
  totalPages,
} = tableHock('patient/support-category')
...
<template>
  <div>
    ...
    <PageHeader
      :title="$t('Patients support category')"
      :text="$t('From here you can manage system patients support category')"
    />
    <VCard>
      <!-- items table -->
      <Table
        :headers="headers"
        add-path="support-patientsupportcategory-add"
        :loading="loading"
        :delete-id="deleteId"
        :items="items"
        :options="options"
          ...
          <td>
            ...
            >
              ...
              <VMenu activator="parent">
                <VList>
                  <VListItem :to="`/support/patientsupportcategory/edit/${item.id}`">
                    <template #prepend>
