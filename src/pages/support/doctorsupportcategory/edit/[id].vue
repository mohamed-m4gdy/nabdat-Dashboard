...
const { item, loading, getInputError, saveItem, serverErrors } = formHock<Iform>('doctor/support-category', 'edit', formSetup, validation, parseInt(route.params.id as string))
...
<template>
  <div>
    <div>
      ...
      :links="[
        ...
        },
        {
          ...
          link: '/support/doctorsupportcategory/list'
        },
        {
          title: $t('Edit')
        }
    ...
    <VCard
      id="invoice-list"
      :title="$t('Edit doctor support category')"
    >
      <Form
        :loading="loading"
        :errors="[]"
