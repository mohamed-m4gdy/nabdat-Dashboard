...
const { item, loading, getInputError, saveItem, serverErrors } = formHock<Iform>('doctor/support-category', 'add', formSetup, validation)
...
<template>
  <div>
    ...
    <VCard
      id="invoice-list"
      :title="$t('Add doctor support category')"
    >
      <Form
        :loading="loading"
        :errors="[]"
