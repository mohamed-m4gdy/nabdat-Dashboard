...
const { item, loading, getInputError, saveItem, serverErrors } = formHock<Iform>('calendars', 'edit', formSetup, validation, parseInt(route.params.id as string))
...
<template>
  <div>
    ...
    <profileData class="mb-3" />

    <VCard
      id="invoice-list"
      :title="$t('Edit workspace calender')"
    >
      <Form
        :loading="loading"
        :errors="[]"
