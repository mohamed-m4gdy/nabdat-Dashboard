...
const { item } = fetchHock('calendar-logs/show',   (route.params.id as string).split('/')[1] as any as number)
  ...
  <div>
    <div>
      ...
      :links="[
        ...
        {
          title: $t('Calender'),
          link: `/clinics/workspace/calender/${  (route.params.id as string).split('/')[0] as any as number}/${(route.params.id as string).split('/')[1] as any as number}`
        },
        {
          title: $t('Calendar Logs')
        }
      ]"
    />
    </div>
