...
const { item, loading, getInputError, saveItem, serverErrors } = formHock<Iform>('promotion-settings', 'edit', formSetup, validation, parseInt(route.params.id as string))
...
<template>
  <div>
    ...
    <VCard
      id="invoice-list"
      :title="$t('Edit promotion settings')"
    >
      <Form
        :loading="loading"
        :errors="[]"
